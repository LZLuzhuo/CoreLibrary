...
public class RSAUtil {
    ...
    public RSAUtil(@NonNull @RAS_Transformation String transformation) {
        try {
     ...
     * @return
     */
    public Map<String,String> generateKeyPair(String filePath){
        try {
     ...
     * @return
     */
    public String fileEncrypt(String publicKeystore, String plainText){
        try {
     ...
     * @return
     */
    public String decrypt(PrivateKey privateKey, String enStr){
        try {
     ...
     * @return
     */
    public String decrypt(String privateKey, String enStr){
        try {
     ...
     * @return
     */
    public String fileDecrypt(String privateKeystore, String enStr){
        try {
    ...
    public static void test() {
        ...
        Log.e(TAG, "=== 公钥加密 私钥解密 ===");
        String source = "需要加密的内容";

        RSAUtil rsa = new RSAUtil(RSAUtil.RSA_PKCS1);
        String encryptData = rsa.encrypt(publicKey, source);
        String decryptData = rsa.decrypt(privateKey, encryptData);

        Log.e(TAG, "加密前的文字: " + source);
        Log.e(TAG, "加密后的文字: " + encryptData);
        Log.e(TAG, "解密后的文字: " + decryptData);
    }
}